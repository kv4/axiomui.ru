...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Аудит стоит фиксированно по размеру системы: один сайт — 90 000 ₽, сайт + портал/ERP (или 4–8 интеграций) — 120 000 ₽, несколько систем (или 9+ интеграций) — 150 000 ₽. Размер системы определим по короткой анкете, цена фиксируется до начала работ и не меняется. Регулярное сопровождение и оптимизация — по ежемесячной подписке (пакеты от 15 до 40 часов в месяц).",
  },
];
