...
const FAQ_ITEMS = [
  {
    ...
    a: "Мы используем защищенные корпоративные API с юридической гарантией неиспользования данных для обучения публичных моделей, либо разворачиваем локальные (on-premise) LLM-модели на ваших серверах. Весь код остается строго внутри вашего контура безопасности.",
  },
  {
        ...
        <div className="mt-14 grid grid-cols-1 gap-5 lg:grid-cols-2">
          ...
          <div className="group relative flex flex-col overflow-hidden rounded-2xl border border-slate-300 bg-white p-8 shadow-sm transition-all hover:border-indigo-400 hover:shadow-xl hover:shadow-indigo-100/70 sm:p-10">
            ...
            <ul className="relative mt-7 space-y-4">
              {[
                ["Deep Technical Audit", "Выявление уязвимостей, узких мест производительности и скрытых зависимостей"],
                ["Снятие зависимости от авторов кода", "Покрытие критических узлов тестами и документирование архитектуры"],
                ["Плановое сопровождение", "Багфикс, обновление библиотек и постепенный рефакторинг по согласованному SLA"],
              ].map(([bold, text]) => (
